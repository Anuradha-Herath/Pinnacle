...
export default function CouponCreate() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const couponData = {
        ...formData,
        price: formData.price, // Price is already in LKR
      ...
      Object.keys(couponData).forEach((key) => {
        if (
          couponData[key as keyof FormData] === undefined ||
          couponData[key as keyof FormData] === null
        ) {
                  ...
                  <div className="flex gap-8">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() =>
                          setFormData({ ...formData, couponStatus: "active" })
                        }
                        className="w-3 h-3"
                      />
                      <span>Active</span>
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() =>
                          setFormData({ ...formData, couponStatus: "inactive" })
                        }
                        className="w-4 h-4"
                      />
                      <span>In Active</span>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md mb-6 max-w-2xl mx-auto">
                  ...
                  <div className="mb-4 flex items-center gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder="Enter Price in LKR" // Updated placeholder
                        className="block w-full border border-gray-300 p-2 rounded-xl"
                  ...
                  <div className="flex gap-6 mb-4">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() =>
                          setFormData({ ...formData, customerEligibility: "new user" })
                        }
                        className="w-4 h-4"
                      />
                      <span>New User</span>
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() =>
                          setFormData({
                            ...formData,
                            customerEligibility: "loyalty customers",
                          })
                        }
                        className="w-4 h-4"
                      />
                    ...
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() =>
                          setFormData({ ...formData, customerEligibility: "all" })
                        }
                        className="w-4 h-4"
                      />
                      <span>All</span>
                  ...
                  <div>
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() =>
                          setFormData({ ...formData, oneTimeUse: !formData.oneTimeUse })
                        }
                        className="w-4 h-4"
                      />
