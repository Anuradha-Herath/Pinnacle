  ...
  return (
    ...
    >
      ...
      {hasDiscount && discountPercentage && (
        <div className="absolute top-5 left-3 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full z-10">
      ...
      {product.category !== "Accessories" && productWithDefaults.sizes.length > 0 && (
        ...
        <button 
          ...
          className="mt-3 w-full bg-black text-white py-2 rounded hover:bg-gray-800 transition-colors flex items-center justify-center gap-2"
        >
          <ShoppingBag size={16} />
          Add to Cart
        </button>
